public class MyWarehouse extends Warehouse {
    ...
    /**
     * Тут применяем принцип открытости/закрытости и принцип подстановки Барбары Лисков - например мы хотим открыть свой склад и отправлять каждому клиенту смс при отгрузке
